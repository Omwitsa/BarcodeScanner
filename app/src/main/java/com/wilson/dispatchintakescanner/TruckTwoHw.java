...
public class TruckTwoHw extends AppCompatActivity {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ctr1 = Integer.toString(mydb.getTruckCount("2", sdate, "2", farm));
...
//        txtTemplate.setText("Template \"" + TEMPLATE_NAME + "\", must be available in the device to run this application. Please use DataWedgeMGR via StageNow to push the templates to device");
        ...
        today.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mydb = new DBHelper(TruckTwoHw.this);
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter(TruckTwoHw.this, android.R.layout.simple_list_item_1, product_code_list);
                ...
                btnDownload.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        bundle.putString("Truckno", "2");

                        Intent ex= new Intent(TruckTwoHw.this, FileExport.class);
                        ex.putExtras(bundle);
                        startActivity(ex);
                    }
                });
        ...
        extoday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TruckTwoHw.this, "downloaded", Toast.LENGTH_SHORT).show();
                Bundle bundle = new Bundle();
                bundle.putString("Type", type);
                bundle.putString("Truckno", "2");
...
//                    textView.setText(finalcode);
                    if(codel>12){
                        AlertDialog.Builder builder1 = new AlertDialog.Builder(TruckTwoHw.this);
...
//                               });
                        ...
                        if(rc==0){
                            mydb.insertProduct(finalcode, "2", "2", farm);
                            Toast.makeText(TruckTwoHw.this, "New",
                                    Toast.LENGTH_SHORT).show();
                            String ctr2 = Integer.toString(mydb.getTruckCount("2", datecreated, "2", farm));
                            truckCount.setText(ctr2);
                        }
                        else{
                            Toast.makeText(TruckTwoHw.this, "Exists",
                                    Toast.LENGTH_SHORT).show();
                            Vibrator vibrator;
                            vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
                            vibrator.vibrate(700);
